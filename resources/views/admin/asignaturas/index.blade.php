            ...
            @forelse($asignaturas as $asignatura)
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        <a href="{{ route('admin.asignatura.edit', ['asignaturas' => $asignatura]) }}" class="text-blue-400">{{ __("Editar") }}</a> |
                        <a
                            href="#"
                            class="text-red-400"
                        ...
                        <form id="delete-asignaturas-{{ $asignatura->id }}-form" action="{{ route('admin.asignaturas.destroy', ['asignaturas' => $asignatura]) }}" method="POST" class="hidden">
                            @method("DELETE")
                            @csrf
                        </form>
                    </td>
